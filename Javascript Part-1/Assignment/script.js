...
language = 'Gujarati';
// country = 'india'; --Error: script.js:33 Uncaught TypeError: Assignment to constant variable.at script.js:33:9
...
description = `${country} is in ${continent}, and its ${population/2} million people speak ${language}`;
console.log(description);
...
//When we get data from promt it is in String, Therefore string value is not equal to number
//So we change it to number and use '===' operator.
